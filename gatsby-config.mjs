...
import rehypeBetterFootnoteLinks from './plugins/rehype-better-footnote-links/index.mjs';
    ...
    `gatsby-transformer-remark`,
    {
      ...
      options: {
        ...
        mdxOptions: {
          ...
          // rehypeBetterFootnoteLinks improves the footnote links
          // generated by remarkGfm
          rehypePlugins: [rehypeBetterFootnoteLinks],
        },
        gatsbyRemarkPlugins: [
          {
