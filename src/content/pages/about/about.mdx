...
<TwoUp>
![Last seconds 1](./music/last-seconds-1.jpg)
![Last seconds 2](./music/last-seconds-2.jpg)
</TwoUp>
...
The church has a [lay ministry](https://newsroom.churchofjesuschrist.org/article/mormon-lay-ministry), where all of the leaders of the church are not ordained ministers but instead are volunteers from the congregation. Sunday services don't feature a central pastor figure, but instead feature messages from individuals in the congregation. Occasionally I am asked to participate by speaking on a particular message, and some of those messages I will adapt into blog posts.
...
<TwoUp>
![begging](./poppy-begging.gif)
![smiling](./happy-poppy.jpg)
</TwoUp>
