...
<ConnectingAntlrToCodeMirrorTableOfContents entryIndex={0} />
...
import {CodeEditor, WELCOME_TO_ZEPHYR} from '../../../../components/CodeEditor';

<CodeEditor initialValue={WELCOME_TO_ZEPHYR} />
