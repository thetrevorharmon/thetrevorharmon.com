...
export class ZephyrParser extends Parser {
  ...
  public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(
    ZephyrParser._LITERAL_NAMES,
    ZephyrParser._SYMBOLIC_NAMES,
    [],
  );
  ...
  public get grammarFileName(): string {
    return 'ZephyrParser.g4';
  }

  // @Override
  public get ruleNames(): string[] {
    return ZephyrParser.ruleNames;
  }

  // @Override
  public get serializedATN(): string {
    return ZephyrParser._serializedATN;
  }
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            (_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << ZephyrParser.NUMBER) |
                (1 << ZephyrParser.IDENTIFIER) |
                (1 << ZephyrParser.STRING))) !==
              0
          )
        ) {
  ...
  public terminator(): TerminatorContext {
    let _localctx: TerminatorContext = new TerminatorContext(
      this._ctx,
      this.state,
    );
  ...
  public static get _ATN(): ATN {
    if (!ZephyrParser.__ATN) {
      ZephyrParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(ZephyrParser._serializedATN),
      );
    }
...
export class ExpressionContext extends ParserRuleContext {
  public NUMBER(): TerminalNode | undefined {
    return this.tryGetToken(ZephyrParser.NUMBER, 0);
  }
  public IDENTIFIER(): TerminalNode | undefined {
    return this.tryGetToken(ZephyrParser.IDENTIFIER, 0);
  }
  public STRING(): TerminalNode | undefined {
    return this.tryGetToken(ZephyrParser.STRING, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return ZephyrParser.RULE_expression;
  }
  // @Override
  public enterRule(listener: ZephyrParserListener): void {
...
export class KeywordContext extends ParserRuleContext {
  public CONST(): TerminalNode | undefined {
    return this.tryGetToken(ZephyrParser.CONST, 0);
  }
  public LET(): TerminalNode | undefined {
    return this.tryGetToken(ZephyrParser.LET, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return ZephyrParser.RULE_keyword;
  }
  // @Override
  public enterRule(listener: ZephyrParserListener): void {
...
export class IdentifierContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return ZephyrParser.RULE_identifier;
  }
  // @Override
  public enterRule(listener: ZephyrParserListener): void {
...
export class AssignContext extends ParserRuleContext {
  ...
  // @Override
  public get ruleIndex(): number {
    return ZephyrParser.RULE_assign;
  }
  // @Override
  public enterRule(listener: ZephyrParserListener): void {
...
export class TerminatorContext extends ParserRuleContext {
  public SEMICOLON(): TerminalNode {
    return this.getToken(ZephyrParser.SEMICOLON, 0);
  }
  constructor(parent: ParserRuleContext | undefined, invokingState: number) {
    super(parent, invokingState);
  }
  // @Override
  public get ruleIndex(): number {
    return ZephyrParser.RULE_terminator;
  }
  // @Override
  public enterRule(listener: ZephyrParserListener): void {
